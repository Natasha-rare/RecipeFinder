...
extension HomeController{
    ...
    func loadViewWithoutCards(){
        ...
        buttonText.load(title: "text", frame: CGRect(x: 144, y: 333, width: UIScreen.main.bounds.width * 0.50, height: 60))
        buttonVoice.load(title: "voice", frame: CGRect(x: 144, y: 433, width: UIScreen.main.bounds.width * 0.50, height: 60))
        buttonScan.load(title: "camera", frame: CGRect(x: 144, y: 533, width: UIScreen.main.bounds.width * 0.50, height: 60))
