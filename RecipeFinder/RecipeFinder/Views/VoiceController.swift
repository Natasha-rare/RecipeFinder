...
class VoiceController: UIViewController {
    ...
    override func viewDidLoad() {
        ...
        buttonSet.load(title: "set", frame: CGRect(x: 58, y: 584, width: 259, height: 58))
        buttonSet.addTarget(self, action: #selector(self.buttonSetPressed), for: .touchDown)
        buttonSet.addTarget(self, action: #selector(self.buttonClickedDown(_:)), for: .touchDown)
        super.view.addSubview(button)
        super.view.addSubview(buttonSet)
